...
public class UnitTests {
    ...
    @Test
    void testMatchingEngineWithEmptyInput() throws FileNotFoundException {
        String input = "";
    ...
    @Test
    void testMatchingEngineWithSameIDInput() throws FileNotFoundException {
        String input =
                "DF ID1 BUY 5000 110.0 VEX123\n" +
                "DF ID01 SELL 5000 100.0 VEX123\n" +
                "FINISH\n";
